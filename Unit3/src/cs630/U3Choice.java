...
public class U3Choice extends Task
{
	// Task Code
	...
	{
		if (currentTrial != null) trials.add (currentTrial);
	...
	public int analysisIterations ()
	{
		...
		// for final runs, return 10 to collect data from 10 simulated experiment participants
		return 1;
	}
	...
	public Result analyze (Task[] tasks, boolean output)
	{
		...
		{
			U3Choice task = (U3Choice) (tasks[i]);
